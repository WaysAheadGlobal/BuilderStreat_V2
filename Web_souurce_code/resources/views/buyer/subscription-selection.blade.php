...
<style>
    ...
    .subcription-sec{
        background: url(https://builderstreat.ca/public/images/sub-banner.png);
...
<div class="container">
    ...
    <div class="price-card">
         <?php
         if((isset($suscription)) && (count($suscription) > 0) ){
            foreach ($suscription as $key => $value) { ?>
        <div class="sub-card">
            <div class="membership-detail">
          <img src="https://builderstreat.ca/public/images/badge.png">
           ...
           <h2>Success Fees : {{ ($value->success_fee) ? $value->success_fee : ''}} on Total Trade Value </h2>
            ...
            <div class="sub-price">
                ...
                <a href="{{ url('/buyer-payment'.'/'.$value->id) }}"> Get started</a>
