                ...
                <form method="POST" action="{{ route('buyer.buyer-product-search') }}">
                    ...
                    <div class="const">
                        ...
                        <select class="form-select" id="cars" name="carlist" form="carform" disabled>
                            <option value="volvo">Select Cateory</option>
                ...
                <div class="col-md-4">
                    <?php if($detail->file !="")
                    {
                        ...
                        <a href="{{ url('/buyer-product-details'.'/'.$detail->id) }}">
                            <figure class="image">
                                <img class="eit-image" src='{{ asset("$image") }}' alt="Image">
                    ...
                    <?php }else{?>
                        <a href="{{ url('/buyer-product-details'.'/'.$detail->id) }}">
                            <figure class="image">
                                <img src="{{ asset('images/buyer/category1.png') }}" alt="Image">
                                <a href="{{ url('/buyer-wishlist-add'.'/'.$detail->id) }}">
                                    <img class="eit-image" src="{{ asset('images/seller/wishlist_icon.svg') }}" style="position: absolute;top: -4px;right: 39px;">
                                </a>
                            </figure>
                        </a>
                    <?php } ?>
