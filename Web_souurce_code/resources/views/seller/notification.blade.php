...
<div class="container-fluid "  style="background-color: lightgrey; padding-bottom: 5%">
<div class="container" style="background-color: white; height: 610px; position: relative;
...
">27 Aug 2022,2:00 PM</span>
   <div class="card notification-card notification-invitation">
    <div class="card-body" style="min-height: 60px;">
      <table>
        <tr>
          <td class="table-row"style="width:70%"><div class="card-title">You have recieved reply of your RFQ from blue ledder construction.</div></td>
          <td style="width:30%">
            <a href="#" class="view-btn">View</a>
          </td>
        </tr>
