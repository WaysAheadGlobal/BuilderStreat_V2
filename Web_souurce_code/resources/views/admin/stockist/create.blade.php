...
@section('content')
	...
	<div class="col-xl-12 order-xl-1">
        <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
            	<form action="{{ route('admin.save.stockist') }}" method="post" enctype="multipart/form-data">
            		<h6 class="heading-small text-muted mb-4">{{ __('Stockist information')}}</h6>
                	@csrf
                	<div class="row">
                		<div class="mb-3 col">
                    ...
                    <div class="row">
                    	<div class="mb-3 col">
                    	    ...
                    	    <input type="text" class="form-control" id="username" name="username" value="" placeholder="Login name" autocomplete="off">
                    ...
                    <div class="row">
                    	...
                    	<div class="mb-3 col">
                    	    ...
                    	    <input type="text" class="form-control" id="city" name="city" value="" placeholder="City name">
                    	    @if ($errors->has('city'))
                    ...
                    <div class="row">
                    	...
                    	<div class="mb-3 col">
                    	    ...
                    	    <input type="text" class="form-control" id="phone2" name="phone2" value="" placeholder="Phone No. 2">
